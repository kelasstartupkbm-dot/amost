...
export default function AccountNotificationPage() {
  ...
  return (
    <AccountAppShell
      ...
      title="Notification"
      eyebrow="Notifikasi"
      description="Pemberitahuan event, results, doorprize, dan update sistem."
      icon={Bell}
      ...
      <section className="space-y-5">
        <section className="rounded-[2rem] border border-slate-200 bg-white p-6 shadow-sm">
          <div className="mb-4 rounded-2xl bg-green-50 px-4 py-3 text-xs font-black uppercase tracking-[0.18em] text-green-700">
            Account Menu Active · Notification
          </div>
          ...
          <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div>
              ...
              <p className="mt-2 max-w-3xl text-sm font-semibold leading-7 text-slate-500">
                Nanti halaman ini menampilkan pemberitahuan sistem, event, results, official, dan doorprize.
              </p>
            </div>
