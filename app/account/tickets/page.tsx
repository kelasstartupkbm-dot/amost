...
export default function AccountTicketsPage() {
  ...
  return (
    <AccountAppShell
      ...
      title="My Tickets"
      eyebrow="Tiket event"
      description="Nomor peserta dan status pendaftaran event kamu."
      icon={Ticket}
      ...
      <section className="space-y-5">
        <section className="rounded-[2rem] border border-slate-200 bg-white p-6 shadow-sm">
          <div className="mb-4 rounded-2xl bg-green-50 px-4 py-3 text-xs font-black uppercase tracking-[0.18em] text-green-700">
            Account Menu Active · My Tickets
          </div>
          ...
          <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div>
              ...
              <p className="mt-2 max-w-3xl text-sm font-semibold leading-7 text-slate-500">
                Nanti halaman ini menampilkan nomor peserta, event yang sudah didaftarkan, dan status pendaftaran.
              </p>
            </div>
