...
export default function AccountEventLiveViewPage() {
  ...
  useEffect(() => {
    const marker = document.querySelector("[data-amost-live-fit-page]");
  ...
  return (
    ...
    >
      <div data-amost-live-fit-page className="flex h-full min-h-0 flex-col gap-4 overflow-hidden">
        {loading ? (
                  ...
                  <div className="absolute inset-0 z-10 flex items-center justify-center px-8">
                    <div className="max-w-xl rounded-[1.5rem] bg-white/78 p-7 text-center backdrop-blur">
                      ...
                      <p className="mt-3 text-sm font-semibold leading-6 text-slate-700">
                        Peserta event sudah dapat muncul sebagai Standby, tetapi marker peta baru tampil setelah Android
                        mengirim lat/lng ke live_tracking_positions.
                      </p>
